...
namespace ZeroInstall.Commands.WinForms
{
    ...
    public sealed class GuiCommandHandler : GuiTaskHandlerBase, ICommandHandler
    {
        ...
        {
            if (WindowsUtils.IsWindows10) //TODO: !ZeroInstallInstance.IsRunningFromCache && !Locations.IsPortable
        ...
        private static void ShowToastNotification(string title, string message)
        {
            ...
            ToastNotificationManager.CreateToastNotifier("Microsoft.Windows.Computer") // TODO: Pick appropriate applicationId
